...
class PlaylistDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        trackAdapter = PlaylistTracksAdapter { trackEntity ->
            findNavController().navigate(
                PlaylistDetailFragmentDirections
                    .actionPlaylistDetailFragmentToTrackDetailsFragment(trackEntity.trackId)
            )
        }
        ...
        vm.tracks(playlistId).observe(viewLifecycleOwner,
            Observer { list: List<PlaylistTrackEntity> ->
        ...
        binding.btnAddTrack.setOnClickListener {
            val action = PlaylistDetailFragmentDirections
                .actionPlaylistDetailFragmentToSearchFragment()
